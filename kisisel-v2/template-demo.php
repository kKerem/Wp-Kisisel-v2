...
<?php if (have_posts()): while (have_posts()) : the_post(); ?>
			<div class="card shadow mb-3">
				...
				<?php if ( has_post_thumbnail() ) {the_post_thumbnail('full',array('class'=>'mb-4'));}  ?>
					<div class="row mb-2">
					...
					<div class="row mb-2">
						<div class="col-md-6 small text-secondary">
							<?php the_tags( __( 'Etiketler ', 'html5blank' ), ', ', '<br>'); // Separated by commas with a line break at the end ?>
						</div>
						<div class="col-md-6 small text-secondary text-md-right">
							<?php _e( 'Kategori ', 'html5blank' ); the_category(', '); // Separated by commas ?>
						</div>
					</div>
